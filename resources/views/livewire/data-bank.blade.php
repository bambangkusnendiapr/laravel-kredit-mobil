                          ...
                          @else
                              @foreach($bank as $key => $data)
                                  <tr>
                                      ...
                                      <td class="text-right">
                                          <a href="{{ route('harga', $data->id) }}" class="btn btn-success btn-sm">Input Harga Mobil</a>
                                          @role('superadmin')
        ...
        <form wire:submit.prevent="createData">
          <div class="modal-body">
            <div class="form-group">
              ...
              <input wire:model.defer="state.nama" required type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Nama Bank..." autofocus>
              @error('nama')
      ...
      <div class="modal-content">
        ...
        <form wire:submit.prevent="updateData">
          <div class="modal-body">
            <div class="form-group">
                <label for="nama">Nama Bank</label>
                <input wire:model.defer="state.nama" required type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="nama Mobil" autofocus>
                @error('nama')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
