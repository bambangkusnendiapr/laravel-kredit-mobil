...
<div>
  ...
  <section class="content-header">
      ...
      <div class="row mb-2">
          <div class="col-sm-6">
          <h1>Data Kredit {{ $order->buyer->nama }}</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="row">
          ...
          <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-4">
                    <p>Tipe Mobil : <strong>{{ $order->car->type }}</strong></p>
                    <p>Harga Mobil : <strong>Rp. {{ number_format($order->car->price_nett + $order->car->price_sales, 0) }},-</strong></p>
                  </div>
                  <div class="col-md-4">
                    <p>Kredit : <strong>{{ $order->kredit*12 }} bln / {{ $order->kredit }} thn</strong></p>
                    <p>Jumlah Bayar : <strong>{{ $credits->count() }} kali</strong></p>
                  </div>
                  <div class="col-md-4">
                    <p>Sudah Bayar : <strong>Rp. {{ number_format($credits->sum('nominal'), 0) }},-</strong></p>
                    <p>Sisa : <strong>Rp. {{ number_format(($order->car->price_nett + $order->car->price_sales) - $credits->sum('nominal'), 0) }},-</strong></p>
                  </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="table-responsive-sm">
                  <table class="table table-sm table-striped mt-1">
                      ...
                      <tbody>
                          ...
                          @else
                              @foreach($credits as $key => $data)
                                  <tr>
                                      <td class="text-center">{{ $credits->firstItem() + $key }}</td>
  ...
  <div class="modal fade" id="form" wire:ignore.self>
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form wire:submit.prevent="createCredit">
  ...
  <div class="modal fade" id="modal-edit" wire:ignore.self>
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form wire:submit.prevent="updateCredit">
          <div class="modal-body">
            <div class="form-group">
              <label for="tanggal">Tanggal</label>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-header">
              ...
              <div class="modal-footer justify-content-between">
                  ...
                  <button wire:click.prevent="deleteCredit" type="button" class="btn btn-outline-light">Lanjut Hapus</button>
              </div>
          </div>
          <!-- /.modal-content -->
      </div>
