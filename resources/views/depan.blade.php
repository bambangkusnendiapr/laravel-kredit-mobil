    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url({{ asset('depan/assets/img/hero-carousel/Slide1.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Suzuki Car</h2>
                <p class="animate__animated animate__fadeInUp">Suzuki Car! Way Of Life! Nyalakan Nyali!</p>
                <a href="https://api.whatsapp.com/send/?phone=6288222555835&text&app_absent=0" target="_blank" class="btn-get-started scrollto animate__animated animate__fadeInUp">Hubungi Sales</a>
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url({{ asset('depan/assets/img/hero-carousel/Slide2.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">My Suzuki</h2>
                <p class="animate__animated animate__fadeInUp">Suzuki! Berani Beda!</p>
                <a href="https://api.whatsapp.com/send/?phone=6288222555835&text&app_absent=0" target="_blank" class="btn-get-started scrollto animate__animated animate__fadeInUp">Hubungi Sales</a>
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url({{ asset('depan/assets/img/hero-carousel/Slide3.jpg') }})">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Mobilku Suzuki!</h2>
                <p class="animate__animated animate__fadeInUp">Mobil Modern Modis Masa Kini</p>
                <a href="https://api.whatsapp.com/send/?phone=6288222555835&text&app_absent=0" target="_blank" class="btn-get-started scrollto animate__animated animate__fadeInUp">Hubungi Sales</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="text-center mt-5">
          <a href="{{ route('front.mobil') }}" class="btn btn-lg btn-success w-50">Lihat Semua Mobil</a>
        </div>
    ...
    <section id="contact" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h3>Kontak Kami</h3>
          <p>Hubungi Kami untuk penjelasan lebih lanjut</p>
        </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Alamat</h3>
              <address>Jl. Ahmad Yani No 259 Bandung</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <p><a href="https://api.whatsapp.com/send/?phone=6288222555835&text&app_absent=0" target="_blank">+62 8822 2555 835</a></p>
              <p><a href="https://api.whatsapp.com/send/?phone=6281320405200&text&app_absent=0" target="_blank">+62 8132 0405 200</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="andrewbahari9@gmail.com" target="_blank">andrewbahari9@gmail.com</a></p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="{{ route('front.mobil') }}">Mobil</a></li>
            </ul>
          </div>
