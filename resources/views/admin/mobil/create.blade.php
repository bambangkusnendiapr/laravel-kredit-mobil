                ...
                <div class="card-body">
                  <form action="{{ route('mobils.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input required name="tipe" type="text" class="form-control @error('tipe') is-invalid @enderror" id="tipe" placeholder="Tipe Mobil" autofocus>
                      @error('tipe')
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="ket" name="ket" class="form-control @error('ket') is-invalid @enderror" placeholder="ket..."></textarea>
                      @error('ket')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
